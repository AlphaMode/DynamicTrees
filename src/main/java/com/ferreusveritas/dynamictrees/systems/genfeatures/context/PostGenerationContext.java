...
public class PostGenerationContext extends GenerationContext<LevelAccessor> {
     ...
     * @param seasonValue           The current season value, as obtained from {@link SeasonProvider#getSeasonValue(Level,
     *                              BlockPos)}.
     * @param fruitProductionFactor The current fruit production factor, as obtained from {@link
     *                              Species#seasonalFruitProductionFactor(Level, BlockPos)}.
     */
