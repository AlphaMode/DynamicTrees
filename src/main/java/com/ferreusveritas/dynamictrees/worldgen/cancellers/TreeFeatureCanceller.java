 ...
 * the given class, or that extends {@link RandomFeatureConfiguration} and contains a feature that has a config
...
public class TreeFeatureCanceller<T extends FeatureConfiguration> extends FeatureCanceller {
    ...
    /**
     * Checks if the given {@link RandomFeatureConfiguration} contains trees.
     *
