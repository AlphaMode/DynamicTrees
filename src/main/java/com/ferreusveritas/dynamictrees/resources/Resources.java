...
/**
 * Holds and registers data pack entries ({@link PreparableReloadListener} objects).
 *
...
public final class Resources {
    ...
    public static final class ReloadListener implements PreparableReloadListener {
        ...
        @Override
        public CompletableFuture<Void> reload(PreparationBarrier stage, net.minecraft.server.packs.resources.ResourceManager resourceManager,
